        ...
        <View className="bg-primary flex-1">
            <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
                ...
                <View className="flex-col items-start justify-center mt-5 px-5">
                    ...
                    <View className="flex-row items-center accent-purple-900 px-2 py-1 rounded-md gap-x-1 mt-2">
            ...
            <TouchableOpacity className="absolute bottom-5 left-0 right-0 mx-5 text-purple-500 rounded-lg py-3.5 flex flex-row items-center justify-center z-50" onPress={router.back}>
